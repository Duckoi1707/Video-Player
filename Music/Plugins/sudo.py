...
@app.on_message(filters.command("12addsudo") & filters.user(OWNER))
...
@app.on_message(filters.command("12delsudo") & filters.user(OWNER))
...
@app.on_message(filters.command("12sudolist"))
